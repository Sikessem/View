 ...
 * @method static \Sikessem\View\Contracts\IsComponentConfig componentConfig(string $component, mixed $default = [])
 ...
 * @method static \Sikessem\View\Contracts\IsComponentTag makeComponentTag(string $component, array|\Illuminate\View\ComponentAttributeBag $attributes = [], string|\Illuminate\View\ComponentSlot $contents = null)
